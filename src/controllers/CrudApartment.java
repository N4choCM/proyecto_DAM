...
public class CrudApartment {
    ...
    /**
     * Method that finds Apartments by their floor field. It will be later
     * linked to the listener of the 'Buscar por planta' button (btnSearch).
     *
    ...
    /**
     * TODO Method that finds Apartments by their floor field. It will be later
     * linked to the listener of the 'Buscar por planta' button (btnSearch).
     *
     * @param search The data entered by the user to be found in the DB.
     * @return An instance of javax.swing.table.DefaultTableModel with all the
    ...
    /**
     * Method that enters a new Apartment in the DB. It will be later linked to
     * the listener of the 'Nuevo' button (btnNew).
     *
     * @param apartment The data of the new Apartment to be stored in the DB.
     * @return True if the new Apartment was stored successfully or false if it
     * was not.
     */
    ...
    /**
     * Method that updates an Apartment in the DB. It will be later linked to
     * the listener of the 'Editar' button (btnUpdate).
     *
     * @param apartment The data of the Apartment to be updated in the DB.
     * @return True if the Apartment was updated successfully or false if it was
     * not.
     */
    ...
    /**
     * Method that updates the state of an Apartment from Unavailable to
     * Available
     *
     * @param apartment The Apartment whose status is going to be changed.
     * @return True if the status was successfully changed and false if it was
     * not.
     */
    ...
    /**
     * Method that updates the state of an Apartment from Available to
     * Unavailable
     *
     * @param apartment The Apartment whose status is going to be changed.
     * @return True if the status was successfully changed and false if it was
    ...
    /**
     * Method that deletes an Apartment in the DB. It will be later linked to
     * the listener of the 'Eliminar' button (btnDelete).
     *
     * @param apartment The data of the Apartment to be deleted in the DB.
     * @return True if the Apartment was deleted successfully or false if it was
     * not.
     */
